...
class music_cog(commands.Cog):
    ...
    def play_next(self):
        if len(self.music_queue) > 0:
            ...
            self.vc.play(discord.FFmpegPCMAudio(m_url, **self.FMMPEG_OPTIONS), after=lambda e: self.play_next())
        else:
            self.is_playing = False
    ...
    @commands.command(name="play", aliases=["p"], help="Play the selscted song from Youtube")
    ...
    @commands.command(name="clear", aliases=["c"], help="Clears the entire queue")
    ...
    @commands.command(name="leave", aliases=["disconnect"], help="Kick the bot from the voice channel")
